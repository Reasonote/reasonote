          ...
          <Stack alignItems="center" spacing={6}>
            ...
            >
              <Stack spacing={4} alignItems="center" sx={{ mx: 'auto', width: '100%', maxWidth: '48rem' }}>
                ...
                >
                  Reasonote is the hub for mastering the information you value most. It's built on open‑source foundations, so you can see under the hood and make it your own.
                </Txt>
              </Stack>
            </motion.div>
