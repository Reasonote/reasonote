...
import {ShareEntityRoute} from "./routeSchema";

export const {POST} = makeServerApiHandlerV3({
  route: ShareEntityRoute,
  handler: async (ctx) => {
    ...
    // TODO: must be share on specific entity type.
    // [https://www.notion.so/TODO-must-be-share-on-specific-entity-type-159bad526459807388a8d8bca6bb9bf0?pvs=4] 
