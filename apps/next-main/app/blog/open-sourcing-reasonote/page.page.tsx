        ...
        <Box sx={{ mb: 4 }}>
          ...
          <MuiMarkdownDefault>
            {trimLines(`
              ...
              <br/>
              <br/>
              ### 2. Skill Tree & GraphSRS-1 Algorithm
              ...
              <br/>
              <br/>
              While "Spaced Repetition for Skill Sequencing" is a well-studied method for information retention, most implementations are concept-specific and don't account for prerequisite relationships between skills. Our GraphSRS-1 algorithm combines prerequisite relationships and performance scores to determine the best next skill to learn, ensuring a logical learning progression.
              <br/>
              <br/>
