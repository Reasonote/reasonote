...
test.describe('FYP Loading Error', () => {
    test('Onboarding to fyp -- error loading', async ({ page }, testInfo) => {
        ...
        await page.goto('/app/foryou?test__force_failure=true');

        await page.waitForSelector('text=Issue Loading Activities')
    });
});