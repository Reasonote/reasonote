...
-- 
---------------------------------------------------------------------------
-- Function: public.link_anon_user_to_user

---------------------------------------------------------------------------
-- BEGIN: PG_DUMP RESULT (FUNCTION: public.link_anon_user_to_user)
------------------------------
...
------------------------------
-- END: PG_DUMP RESULT (FUNCTION: public.link_anon_user_to_user)
---------------------------------------------------------------------------
