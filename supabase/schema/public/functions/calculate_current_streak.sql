...
-- 
---------------------------------------------------------------------------
-- Function: public.calculate_current_streak

---------------------------------------------------------------------------
-- BEGIN: PG_DUMP RESULT (FUNCTION: public.calculate_current_streak)
------------------------------
CREATE OR REPLACE FUNCTION public.calculate_current_streak(user_id text, input_skill_id text)
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE
...
------------------------------
-- END: PG_DUMP RESULT (FUNCTION: public.calculate_current_streak)
---------------------------------------------------------------------------
