...
-- 
---------------------------------------------------------------------------
-- Function: public._finish

---------------------------------------------------------------------------
-- BEGIN: PG_DUMP RESULT (FUNCTION: public._finish)
------------------------------
CREATE OR REPLACE FUNCTION public._finish(integer, integer, integer, boolean DEFAULT NULL::boolean)
 RETURNS SETOF text
 LANGUAGE plpgsql
AS $function$
DECLARE
...
------------------------------
-- END: PG_DUMP RESULT (FUNCTION: public._finish)
---------------------------------------------------------------------------
