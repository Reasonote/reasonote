...
-- 
---------------------------------------------------------------------------
-- View: public.vw_lesson_memauth

---------------------------------------------------------------------------
-- BEGIN: PG_DUMP RESULT (VIEW: public.vw_lesson_memauth)
------------------------------
--
...
--
-- Name: vw_lesson_memauth; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.vw_lesson_memauth AS
 ...
 SELECT flattened.memauth_id,
   ...
   FROM ( SELECT combined_permissions.memauth_id,
            ...
            combined_permissions.lesson_id,
  ...
  GROUP BY flattened.memauth_id, flattened.principal_id, flattened.principal_type, flattened.lesson_id, flattened.access_level;


ALTER TABLE public.vw_lesson_memauth OWNER TO postgres;

--
-- Name: VIEW vw_lesson_memauth; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE vw_lesson_memauth; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.vw_lesson_memauth TO anon;
GRANT ALL ON TABLE public.vw_lesson_memauth TO authenticated;
GRANT ALL ON TABLE public.vw_lesson_memauth TO service_role;
...
------------------------------
-- END: PG_DUMP RESULT (VIEW: public.vw_lesson_memauth)
---------------------------------------------------------------------------
