...
import { RESIChatBaseRequestSchema } from '../types';
...
export const RESIChatRequestOpenaiSchema = RESIChatBaseRequestSchema.extend({
  driverConfig: z.object({
    type: z.literal("openai"),
    config: OpenAIConfigSchema,
  }),
});
export type RESIChatRequestOpenai = z.infer<typeof RESIChatRequestOpenaiSchema>;

export const RESIChatRequestSchema = RESIChatRequestOpenaiSchema;
export type RESIChatRequest = z.infer<typeof RESIChatRequestSchema>;
